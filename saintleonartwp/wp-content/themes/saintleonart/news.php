		...
		<section class="all-news">
			...
			<div class="all-news__actu">
				<h3  class="all-news__heading3 heading3" aria-level="3" role="heading">Actu name</h3>
				...
				<div class="all-news__content">
					<p class="all-news__content--txt">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero, cumque, incidunt. Dolor sed veritatis reprehenderit tempore consequuntur, esse quibusdam repellat voluptatem, recusandae vero beatae dicta cta aut, ex, sunt unde. Eveniet.</p>
					<p class="all-news__content--txt">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero, cumque, incidunt. Dolor sed veritatis reprehenderit tempore consequuntur, esse quibusdam repellat voluptatem, recusandae vero beatae dicta cta aut, ex, sunt unde. Eveniet.</p>
				</div>
				<a href="#" class="all-news__actu--link" title="Aller vers la page de l'actualité" ><p>Voir l'article</p><span>+</span></a>
			</div>
			<div class="all-news__actu">
				<h3  class="all-news__heading3 heading3" aria-level="3" role="heading">Actu name</h3>
				<div class="all-news__actu--date">
