		...
		<nav class="sec-nav">
			...
			<ul class="sec-nav__list">
				<li class="sec-nav__list--elt">
					<a href="./programme.html" class="sec-nav__list--txt">Programme</a>
					<span>
				...
				<li class="sec-nav__list--elt">
					...
					<a href="./agenda.html" class="sec-nav__list--txt active">Agenda</a>
				</li>
			</ul>
		</nav>
		<section class="title">
			<h2 class="title__heading2 heading2" aria-level="2" role="heading">Agenda</h2>
		</section>
