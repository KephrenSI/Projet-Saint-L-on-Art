<?php get_header(); ?>
        ...
        <section class="last-event">
            ...
            <div class="last-event__event">
                <a class="last-event__event--bloc" href="#" title="Aller vers la page de l'évènement">&nbsp;</a>
                <img class="last-event__event--img" src="<?php the_post_thumbnail_url('medium_large');?>" alt="Image de présentations de l'évènement <?php the_title();?>">
                <div class="last-event__event--taxonomy">
                    <?php dw_the_category(', ', '<strong class="">', '</strong>'); ?>
                </div>
                <div class="last-event__event--date">
                    <span class="last-event__event--month"><?php the_field('date_month'); ?></p></span>
                    <span class="last-event__event--day"><?php the_field('date_day'); ?></span>
                </div>
                ...
                <div class="last-event__event--social">
                    ...
                    <div class="last-event__event--reseaux">
                        <a class="artistes__artiste--link" href="#" title="Aller vers la page Facebook">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                                <title>facebook</title>
                                <path d="M19 6h5v-6h-5c-3.86 0-7 3.14-7 7v3h-4v6h4v16h6v-16h5l1-6h-6v-3c0-0.542 0.458-1 1-1z"></path>
        ...
        <section class="news">
            ...
            <div class="news__actu">
                ...
                <div class="news__actu--publication_date">Le <?php the_date(); ?></div>
                <!-- <div class="news__actu--date">
                    <span class="news__actu--month"><?php the_field('date_month'); ?></span>
                    <span class="news__actu--day"><?php the_field('date_day'); ?></span>
                </div> -->
                ...
                <a href="#" class="news__actu--link" title="Aller vers la page de l'actualité" ><p>Voir l'article</p><span>+</span></a>
            </div>
            <?php endwhile; endif; ?>
        ...
        <section class="insta">
            ...
            <div class="insta__bloc">
                <a href="#" title="Voir l'image sur Instagram" class="insta__bloc--pix"><img src="./assets/img/insta.jpg" alt="photo instagram de Sophie" width="140"></a>
                <a href="#" title="Voir l'image sur Instagram" class="insta__bloc--pix"><img src="./assets/img/insta.jpg" alt="photo instagram de Sophie" width="140"></a>
                <a href="#" title="Voir l'image sur Instagram" class="insta__bloc--pix"><img src="./assets/img/insta.jpg" alt="photo instagram de Sophie" width="140"></a>
                <a href="#" title="Voir l'image sur Instagram" class="insta__bloc--pix"><img src="./assets/img/insta.jpg" alt="photo instagram de Sophie" width="140"></a>
            </div>
            <!-- <div class="insta__cta cta">
                <a href="#" title="Aller vers la page à propos" >Aller sur Insta</a>
            </div> -->
            <div class="insta__cta cta">
                <span class="cta__masque">Aller sur Insta</span>
                <a href="#" title="Aller vers la page à propos" class="cta__button">Aller sur Insta</a>
            </div>
        </section>
<?php get_footer(); ?>
