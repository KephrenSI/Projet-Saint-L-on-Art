		...
		<section class="title">
			<h2 class="title__heading2 heading2" aria-level="2" role="heading">Évènements</h2>
		</section>
		<section class="all-events">
			...
			<div class="all-events__event">
				<a class="all-events__event--bloc" href="#" title="Aller vers la page de l'évènement">&nbsp;</a>
				<img class="all-events__event--img" src="../img/event.jpg" alt="">
				<div class="all-events__event--taxonomy">
					Concert
				</div>
				<div class="all-events__event--date">
					<span class="all-events__event--month">SEP</span>
					<span class="all-events__event--day">24</span>
				</div>
				...
				<div class="all-events__event--social">
					...
					<div class="all-events__event--reseaux">
						<a class="all-events__event--link" href="#" title="Aller vers la page Facebook">Facebook</a>
						<a class="all-events__event--link" href="#" title="Aller vers la page Twitter">Twitter</a>
					</div>
				</div>
			</div>
			<div class="all-events__event">
